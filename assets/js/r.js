...
//     $('.tab-menu li:first-child').addClass('selected');
//     $('.tab-menu li').click(function (e) {
//         var currentIndex = $(this).index() + 1;
//         $('.tab-contents .brand-tab-content:nth-child(' + currentIndex + ')').show().addClass(
//             'selected').siblings().hide();
//         $(this).addClass('selected').siblings().removeClass('selected');

//         $('.tab-contents1 .brand-tab-content1:nth-child(' + currentIndex + ')').show().addClass(
//             'showDisplay').siblings().hide();
//         $(this).addClass('showDisplay').siblings().removeClass('showDisplay');
//         e.preventDefault();
//     });
// });
...
function chText2() {
    ...
    document.getElementById('useCasesHolder').innerHTML = "An student, teacher or school employee";
    document.getElementById('useCasesVerifier').innerHTML = "A school, nursery, daycare, university, etc.";
}
...
function chText3() {
    ...
    document.getElementById('useCasesHolder').innerHTML = "A tourist, cross-border commuter, traveller";
    document.getElementById('useCasesVerifier').innerHTML =
...
function chText4() {
    ...
    document.getElementById('useCasesVerifier').innerHTML = "A hospital, clinic, long-term care home";
}